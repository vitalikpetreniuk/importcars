...
$(function() {
	...
	$('.edge').prepend('<div class="edge-element"></div>');
	$('.edge.both').append('<div class="edge-element"></div>');
	...
	var feedbacks = $('.slider-feedback').owlCarousel({
        items: 1,
        margin: 30,
        nav: true,
        dots: true,
    ...
    $('.feedback-all button').on('click', function () {
        $(this).toggleClass('open');
        $(this).closest('.feedback-item').find('.feedback-text').toggleClass('open');
        var textInner = $(this).closest('.feedback-item').find('.feedback-text > div').outerHeight();
        var textDif = textInner - 242;
        var slideHeight = $(this).closest('.item').outerHeight();
        if($(this).hasClass('open')){
            var slideHeightAfter = slideHeight + textDif;
        }else{
            slideHeightAfter = slideHeight - textDif;
        }
        feedbacks.find('.owl-stage-outer').css('height', slideHeightAfter);
    });

	var hiwSlider = $('.slider-hiw').owlCarousel({
        items: 1,
        margin: 30,
        nav: true,
        dots: true,
        ...
        $('.hiw-nav-item').eq($(this).find('.owl-dot.active').index()).addClass('active').siblings().removeClass('active');
        var currentSlide, player, command;

        currentSlide = $(this).find('.owl-item.active');
	...
	$('.hiw-nav-item button').on('click', function () {
        $(this).parent().addClass('active').siblings().removeClass('active');
        var hiwIndex = $(this).parent().index();
        hiwSlider.find('.owl-dot').eq(hiwIndex).trigger('click');
    });

    $('select').customSelect();

    $('.faq-title').on('click', function () {
        $(this).toggleClass('active').siblings('.faq-answer').slideToggle('fast').parent().siblings().find('.faq-title').removeClass('active').siblings('.faq-answer').slideUp('fast');
    });

    $('.custom-select').on('mouseover', function () {
        $(this).closest('.calc-block').find('.calc-block-title').addClass('active');
    }).on('mouseleave', function () {
        $(this).closest('.calc-block').find('.calc-block-title').removeClass('active');
    });
    ...
    $('.modal-custom').find('.animated').each(function () {
    ...
    $('.modal-close').on('click', function () {
       $(this).closest('.modal-custom').find('.aos-animate').removeClass('aos-animate');
       $(this).closest('.modal-custom').removeClass('open done');
       $('img').removeClass('delay');
    ...
    $('.modal-open').on('click', function (e) {
       ...
       var target = $(this).attr('data-target');
        $(target).addClass('open').find('.animated').addClass('aos-animate');
        $('html').addClass('overflow-hidden');
        setTimeout(function () {
            $('.animated').find('img').addClass('delay');
        }, 100);
    });

    $('.modal-double .btn-arrow').on('click', function (e) {
        e.preventDefault();
        $(this).closest('.modal-custom').addClass('done');
    });


    $('.pack-item').each(function () {
       var packType = $(this).attr('data-value');
       var packValue = $(this).find('.pack-item-title').html();
       $(this).find('.modal-open').on('click', function () {
          $('.modal-custom.open').removeClass('min mid max').addClass(packType).find('.modal-custom-title span').html(packValue);
       });
    });

    $('.filters-toggle').on('click', function () {
       $(this).closest('.filters-item').toggleClass('open').parent().siblings().find('.filters-item').removeClass('open');
    });

    $('.header-contacts-call .header-contacts-title').on('click', function () {
        $('.header-contacts-call').toggleClass('active');
    });
    ...
    $('.tracking-header button').on('click', function (e) {
        e.preventDefault();
        $('.tracking-cont').show();
    });

    $('.video-link').prepend('<span></span>');

    $('.to-next').on('click', function () {
        $('html,body').animate({scrollTop: $('#benefits').offset().top},'slow');
    });

    $('.calc-result-open').on('click', function () {
